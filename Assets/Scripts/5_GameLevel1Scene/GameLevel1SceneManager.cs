...
public class GameLevel1SceneManager : MonoBehaviour
{
    ...
    [SerializeField] private List<string> selectedStageIds = new List<string> { "Boat", "Cat", "Rocket" };
    ...
    private void HandlePuzzleResult(bool success, StageData stage)
    {
        if (success)
        {
            Debug.Log($"[Game Level 1] Puzzle '{stage.id}' completed!");
        ...
        {
            Debug.Log("[Game Level 1] Puzzle failed.");
